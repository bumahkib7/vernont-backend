CREATE TABLE IF NOT EXISTS api_key (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, last_used_at timestamp(6) with time zone, revoked boolean not null, revoked_at timestamp(6) with time zone, revoked_by varchar(255), title varchar(255) not null, token varchar(255) not null unique, type varchar(255) not null check (type in ('PUBLISHABLE','SECRET')), store_id VARCHAR(36) not null, primary key (id));
CREATE TABLE IF NOT EXISTS app_user (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, avatar_url varchar(255), email varchar(255) not null unique, email_verified boolean, first_name varchar(255), is_active boolean not null, last_login_at timestamp(6) with time zone, last_name varchar(255), password_hash varchar(255) not null, primary key (id));
CREATE TABLE IF NOT EXISTS audit_log (id bigint generated by default as identity, action varchar(255) not null check (action in ('CREATE','READ','UPDATE','DELETE','LOGIN','LOGOUT','LOGIN_FAILED','PERMISSION_DENIED')), description TEXT, entity_id varchar(255) not null, entity_type varchar(255) not null, ip_address varchar(255), metadata jsonb, new_value TEXT, old_value TEXT, timestamp timestamp(6) with time zone not null, user_agent varchar(255), user_id varchar(255) not null, user_name varchar(255), version bigint not null, primary key (id));
CREATE TABLE IF NOT EXISTS brand (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, active boolean not null, description TEXT, logo_url varchar(255), name varchar(255) not null, slug varchar(255) not null, tier varchar(20) not null check (tier in ('LUXURY','PREMIUM','STANDARD')), website_url varchar(255), primary key (id), constraint uk_brand_slug unique (slug));
CREATE TABLE IF NOT EXISTS campaign_execution (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, completed_at timestamp(6) with time zone, emails_failed integer not null, emails_sent integer not null, error_message TEXT, execution_status varchar(255) not null check (execution_status in ('PENDING','RUNNING','COMPLETED','FAILED','CANCELLED')), started_at timestamp(6) with time zone, workflow_execution_id varchar(255), campaign_id VARCHAR(36) not null, primary key (id));
CREATE TABLE IF NOT EXISTS canonical_category (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, depth integer, name varchar(255) not null, path TEXT, slug varchar(255) not null unique, sort_order integer, parent_id VARCHAR(36), primary key (id));
CREATE TABLE IF NOT EXISTS canonical_category_mapping (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, confidence float(53), external_key varchar(512) not null, external_source varchar(255) not null, notes TEXT, canonical_category_id VARCHAR(36) not null, primary key (id), constraint idx_cat_mapping_source_key unique (external_source, external_key));
CREATE TABLE IF NOT EXISTS canonical_category_synonym (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, name varchar(255) not null unique, category_id VARCHAR(36) not null, primary key (id));
CREATE TABLE IF NOT EXISTS cart (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, billing_address_id varchar(255), completed_at timestamp(6) with time zone, currency_code varchar(3) not null, customer_id varchar(255), discount numeric(19,4) not null, discount_total numeric(19,4) not null, email varchar(255), note TEXT, payment_method_id varchar(255), region_id varchar(255) not null, shipping numeric(19,4) not null, address_1 varchar(255), address_2 varchar(255), city varchar(255), country_code varchar(255), first_name varchar(255), last_name varchar(255), phone varchar(255), postal_code varchar(255), province varchar(255), shipping_method_id varchar(255), subtotal numeric(19,4) not null, tax numeric(19,4) not null, tax_amount numeric(19,4) not null, tax_code varchar(255), tax_rate numeric(4,4) not null, total numeric(19,4) not null, primary key (id));
CREATE TABLE IF NOT EXISTS cart_line_item (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, allow_discounts boolean not null, currency_code varchar(3) not null, description varchar(255), discount numeric(19,4), has_shipping boolean, is_giftcard boolean, product_handle varchar(255), quantity integer not null, should_merge boolean, tax_amount numeric(19,4) not null, tax_code varchar(255), tax_rate numeric(4,4) not null, thumbnail varchar(255), title varchar(255) not null, total numeric(19,4) not null, unit_price numeric(19,4) not null, variant_id varchar(255) not null, variant_title varchar(255), cart_id VARCHAR(36) not null, primary key (id));
...
CREATE TABLE IF NOT EXISTS country (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, display_name varchar(255) not null, iso_2 varchar(2) not null unique, iso_3 varchar(3) not null unique, name varchar(255) not null unique, num_code integer not null unique, primary key (id), constraint idx_country_iso2 unique (iso_2), constraint idx_country_iso3 unique (iso_3));
CREATE TABLE IF NOT EXISTS currency (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, code varchar(3) not null unique, decimal_digits integer not null, includes_tax boolean not null, name varchar(255) not null, rounding float(53) not null, symbol varchar(255) not null, symbol_native varchar(255) not null, primary key (id));
CREATE TABLE IF NOT EXISTS customer (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, billing_address_id varchar(255), email varchar(255) not null, first_name varchar(255), has_account boolean not null, internal_notes TEXT, last_login_at timestamp(6) with time zone, last_name varchar(255), last_order_at timestamp(6) with time zone, order_count integer not null, phone varchar(255), status varchar(255) not null check (status in ('ACTIVE','SUSPENDED','BANNED')), suspended_at timestamp(6) with time zone, suspended_reason TEXT, tier varchar(255) not null check (tier in ('BRONZE','SILVER','GOLD','PLATINUM')), tier_override boolean not null, total_spent numeric(19,2) not null, user_id VARCHAR(36) unique, primary key (id));
CREATE TABLE IF NOT EXISTS customer_activity_log (id varchar(36) not null, activity_type varchar(50) not null check (activity_type in ('ACCOUNT_CREATED','ACCOUNT_ACTIVATED','ACCOUNT_SUSPENDED','ACCOUNT_BANNED','PROFILE_UPDATED','PASSWORD_RESET_REQUESTED','PASSWORD_CHANGED','LOGIN','LOGIN_FAILED','TIER_UPGRADED','TIER_CHANGED_MANUALLY','EMAIL_SENT','GIFT_CARD_SENT','ORDER_PLACED','ORDER_CANCELLED','ORDER_REFUNDED','ADDRESS_ADDED','ADDRESS_UPDATED','ADDRESS_REMOVED','BILLING_ADDRESS_SET','ADDED_TO_GROUP','REMOVED_FROM_GROUP','PRODUCT_FAVORITED','PRODUCT_UNFAVORITED','NOTE_ADDED')), created_at timestamp(6) with time zone not null, customer_id varchar(36) not null, description TEXT, metadata jsonb, occurred_at timestamp(6) with time zone not null, performed_by varchar(36), primary key (id));
CREATE TABLE IF NOT EXISTS customer_address (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, address_1 varchar(255) not null, address_2 varchar(255), city varchar(255) not null, company varchar(255), country_code varchar(2) not null, first_name varchar(255), last_name varchar(255), phone varchar(255), postal_code varchar(255), province varchar(255), customer_id VARCHAR(36) not null, primary key (id));
CREATE TABLE IF NOT EXISTS customer_group (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, description TEXT, name varchar(255) not null unique, primary key (id));
...
CREATE TABLE IF NOT EXISTS discount (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, amount numeric(19,4) not null, cart_id varchar(255), code varchar(255) not null, is_applied boolean not null, is_valid boolean not null, order_id varchar(255), reason TEXT, type varchar(255) not null check (type in ('PERCENTAGE','FIXED','FREE_SHIPPING')), value float(53) not null, promotion_id VARCHAR(36), primary key (id));
CREATE TABLE IF NOT EXISTS discount_activity (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, activity_type varchar(255) not null check (activity_type in ('PROMOTION_CREATED','PROMOTION_UPDATED','PROMOTION_ACTIVATED','PROMOTION_DEACTIVATED','PROMOTION_DELETED','CODE_REDEEMED','USAGE_LIMIT_REACHED','PROMOTION_EXPIRED','PROMOTION_DUPLICATED')), actor_id varchar(255), actor_name varchar(255), description TEXT, promotion_id VARCHAR(36), primary key (id));
CREATE TABLE IF NOT EXISTS discount_redemption (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, code_used varchar(255), customer_id varchar(255), discount_amount numeric(38,2) not null, discount_id varchar(255), order_id varchar(255), order_subtotal numeric(38,2), redeemed_at timestamp(6) with time zone not null, promotion_id VARCHAR(36) not null, primary key (id));
CREATE TABLE IF NOT EXISTS email_log (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, bounced_at timestamp(6) with time zone, click_count integer not null, clicked_at timestamp(6) with time zone, delivered_at timestamp(6) with time zone, email_type varchar(255) not null check (email_type in ('PRICE_DROP','NEW_ARRIVALS','WIN_BACK','WEEKLY_DIGEST','MANUAL')), error_message TEXT, failed_at timestamp(6) with time zone, mailersend_message_id varchar(255), open_count integer not null, opened_at timestamp(6) with time zone, recipient_email varchar(255) not null, sent_at timestamp(6) with time zone, status varchar(255) not null check (status in ('PENDING','SENT','DELIVERED','OPENED','CLICKED','BOUNCED','FAILED','UNSUBSCRIBED')), subject varchar(500) not null, campaign_id VARCHAR(36), campaign_execution_id VARCHAR(36), customer_id VARCHAR(36) not null, primary key (id));
CREATE TABLE IF NOT EXISTS fulfillment (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, canceled_at timestamp(6) with time zone, claim_order_id varchar(255), data jsonb, location_id varchar(255), no_notification boolean not null, note TEXT, order_id varchar(255), shipped_at timestamp(6) with time zone, swap_id varchar(255), tracking_numbers TEXT, tracking_urls TEXT, provider_id VARCHAR(36) not null, primary key (id));
CREATE TABLE IF NOT EXISTS fulfillment_item (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, barcode varchar(100), line_item_id varchar(255) not null, quantity integer not null, sku varchar(100), title varchar(255), fulfillment_id VARCHAR(36) not null, primary key (id));
CREATE TABLE IF NOT EXISTS fulfillment_provider (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, config jsonb, is_active boolean not null, name varchar(255) not null, provider_id varchar(255) not null unique, primary key (id));
CREATE TABLE IF NOT EXISTS gift_card (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, code varchar(19) not null unique, currency_code varchar(3) not null, expires_at timestamp(6) with time zone, first_redeemed_at timestamp(6) with time zone, fully_redeemed_at timestamp(6) with time zone, initial_amount integer not null, issued_by_user_id varchar(36), issued_to_customer_id varchar(36), message TEXT, recipient_email varchar(255), recipient_name varchar(255), redeemed_by_customer_id varchar(36), remaining_amount integer not null, status varchar(20) not null check (status in ('ACTIVE','FULLY_REDEEMED','EXPIRED','DISABLED')), primary key (id));
CREATE TABLE IF NOT EXISTS inventory_item (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, height integer, hs_code varchar(255), length integer, material varchar(255), mid_code varchar(255), origin_country varchar(255), requires_shipping boolean not null, sku varchar(255) unique, weight integer, width integer, primary key (id));
CREATE TABLE IF NOT EXISTS inventory_level (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, available_quantity integer not null, incoming_quantity integer not null, reserved_quantity integer not null, stocked_quantity integer not null, inventory_item_id VARCHAR(36) not null, location_id VARCHAR(36) not null, primary key (id), constraint idx_inventory_level_item_location unique (inventory_item_id, location_id));
CREATE TABLE IF NOT EXISTS inventory_movement (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, event_id varchar(255) not null unique, inventory_item_id varchar(255) not null, inventory_level_id varchar(255), location_id varchar(255) not null, location_name varchar(255), movement_type varchar(255) not null check (movement_type in ('STOCK_ADDED','STOCK_REMOVED','ADJUSTMENT','RESERVED','RELEASED','FULFILLED','RETURNED','TRANSFERRED_IN','TRANSFERRED_OUT','CYCLE_COUNT')), new_quantity integer, note varchar(1000), occurred_at timestamp(6) with time zone not null, performed_by varchar(255), previous_quantity integer, product_title varchar(255), quantity integer not null, reason varchar(255), reference_id varchar(255), reference_type varchar(255), sku varchar(255), primary key (id));
CREATE TABLE IF NOT EXISTS inventory_reservation (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, inventory_level_id varchar(255) not null, line_item_id varchar(255), order_id varchar(255), quantity integer not null, released_at timestamp(6) with time zone, primary key (id));
CREATE TABLE IF NOT EXISTS marketing_campaign (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, campaign_type varchar(255) not null check (campaign_type in ('PRICE_DROP','NEW_ARRIVALS','WIN_BACK','WEEKLY_DIGEST','MANUAL')), completed_at timestamp(6) with time zone, config jsonb, description TEXT, email_preheader varchar(255), email_subject varchar(500) not null, email_template_id varchar(255), name varchar(255) not null, scheduled_at timestamp(6) with time zone, started_at timestamp(6) with time zone, status varchar(255) not null check (status in ('DRAFT','SCHEDULED','RUNNING','PAUSED','COMPLETED','CANCELLED')), target_all_customers boolean not null, total_failed bigint not null, total_recipients bigint not null, total_sent bigint not null, target_customer_group_id VARCHAR(36), primary key (id));
CREATE TABLE IF NOT EXISTS marketing_preference (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, email_frequency varchar(255) not null check (email_frequency in ('DAILY','NORMAL','WEEKLY','MONTHLY')), excluded_brands jsonb, excluded_categories jsonb, marketing_emails_enabled boolean not null, new_arrivals_enabled boolean not null, preferred_brands jsonb, preferred_categories jsonb, price_drop_alerts_enabled boolean not null, promotional_enabled boolean not null, unsubscribe_reason varchar(255), unsubscribed_at timestamp(6) with time zone, weekly_digest_enabled boolean not null, customer_id VARCHAR(36) not null unique, primary key (id));
CREATE TABLE IF NOT EXISTS order_address (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, address1 varchar(255) not null, address2 varchar(255), city varchar(255) not null, company varchar(255), country_code varchar(2) not null, first_name varchar(255), last_name varchar(255), phone varchar(255), postal_code varchar(255), province varchar(255), primary key (id));
CREATE TABLE IF NOT EXISTS order_event (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, description TEXT, event_data jsonb, event_type varchar(255) not null check (event_type in ('ORDER_PLACED','ORDER_CONFIRMED','ORDER_UPDATED','ORDER_CANCELED','ORDER_COMPLETED','ORDER_ARCHIVED','PAYMENT_PENDING','PAYMENT_AUTHORIZED','PAYMENT_CAPTURED','PAYMENT_FAILED','PAYMENT_REFUNDED','PAYMENT_PARTIALLY_REFUNDED','FULFILLMENT_CREATED','FULFILLMENT_CANCELED','SHIPMENT_CREATED','SHIPPED','IN_TRANSIT','OUT_FOR_DELIVERY','DELIVERED','DELIVERY_ATTEMPTED','DELIVERY_FAILED','RETURN_REQUESTED','RETURN_APPROVED','RETURN_RECEIVED','RETURN_REJECTED','EXCHANGE_REQUESTED','EXCHANGE_APPROVED','EXCHANGE_COMPLETED','NOTE_ADDED','CUSTOMER_CONTACTED','ADMIN_NOTE_ADDED','STATUS_CHANGED','CUSTOM')), location varchar(255), order_id varchar(255) not null, reference_id varchar(255), reference_type varchar(255), title varchar(255) not null, triggered_by varchar(255), triggered_by_role varchar(255), primary key (id));
CREATE TABLE IF NOT EXISTS order_line_item (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, allow_discounts boolean not null, currency_code varchar(3) not null, description varchar(255), discount numeric(19,4), fulfilled_quantity integer not null, has_shipping boolean, is_giftcard boolean, quantity integer not null, returned_quantity integer not null, shipped_quantity integer not null, should_merge boolean, status varchar(255) not null check (status in ('PENDING','FULFILLED','SHIPPED','PARTIALLY_SHIPPED','RETURNED','CANCELED')), thumbnail varchar(255), title varchar(255) not null, total numeric(19,4) not null, unit_price numeric(19,4) not null, variant_id varchar(255), order_id VARCHAR(36) not null, primary key (id));
CREATE TABLE IF NOT EXISTS orders (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, canceled_at varchar(255), cart_id varchar(255), currency_code varchar(3) not null, customer_id varchar(255), discount numeric(19,4) not null, display_id integer not null unique, email varchar(255) not null, fulfillment_status varchar(255) not null check (fulfillment_status in ('NOT_FULFILLED','PARTIALLY_FULFILLED','FULFILLED','PARTIALLY_SHIPPED','SHIPPED','PARTIALLY_RETURNED','RETURNED','CANCELED','REQUIRES_ACTION')), note TEXT, payment_intent_id varchar(255), payment_method_id varchar(255), payment_status varchar(255) not null check (payment_status in ('NOT_PAID','AWAITING','CAPTURED','PARTIALLY_PAID','PAID','PARTIALLY_REFUNDED','REFUNDED','CANCELED','REQUIRES_ACTION')), region_id varchar(255) not null, shipping numeric(19,4) not null, shipping_method_id varchar(255), status varchar(255) not null check (status in ('PENDING','COMPLETED','ARCHIVED','CANCELED','REQUIRES_ACTION')), subtotal numeric(19,4) not null, tax numeric(19,4) not null, total numeric(19,4) not null, billing_address_id VARCHAR(36) unique, shipping_address_id VARCHAR(36) unique, primary key (id));
CREATE TABLE IF NOT EXISTS payment (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, amount numeric(19,4) not null, amount_refunded numeric(19,4) not null, authorized_at timestamp(6) with time zone, canceled_at timestamp(6) with time zone, captured_amount numeric(19,4), captured_at timestamp(6) with time zone, cart_id varchar(255), currency_code varchar(3) not null, data jsonb, external_id varchar(255), order_id varchar(255), status varchar(255) not null check (status in ('PENDING','AUTHORIZED','CAPTURED','PARTIALLY_REFUNDED','REFUNDED','CANCELED','FAILED','REQUIRES_ACTION')), payment_collection_id VARCHAR(36), payment_session_id VARCHAR(36) unique, provider_id VARCHAR(36) not null, primary key (id));
CREATE TABLE IF NOT EXISTS payment_collection (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, amount numeric(19,4) not null, completed_at timestamp(6) with time zone, currency_code varchar(3) not null, region_id varchar(255), status varchar(255) not null check (status in ('NOT_PAID','PAID','PARTIALLY_PAID','REFUNDED','PARTIALLY_REFUNDED','CANCELED','REQUIRES_ACTION')), primary key (id));
CREATE TABLE IF NOT EXISTS payment_provider (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, config jsonb, is_active boolean not null, is_test_mode boolean not null, name varchar(255) not null, primary key (id));
CREATE TABLE IF NOT EXISTS payment_session (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, amount numeric(19,4) not null, authorized_at timestamp(6) with time zone, context TEXT, currency_code varchar(3) not null, data TEXT, payment_collection_id varchar(255) not null, provider_id varchar(255) not null, status varchar(255) not null check (status in ('PENDING','AUTHORIZED','CAPTURED','CANCELED','ERROR','REQUIRES_ACTION')), primary key (id));
CREATE TABLE IF NOT EXISTS permission (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, action varchar(255), description varchar(255), name varchar(255) not null unique, resource varchar(255), primary key (id));
CREATE TABLE IF NOT EXISTS price (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, amount numeric(19,4) not null, currency_code varchar(3) not null, is_default boolean not null, max_quantity integer, min_quantity integer, region_id varchar(255), price_set_id VARCHAR(36) not null, primary key (id));
CREATE TABLE IF NOT EXISTS price_change_log (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, change_metadata jsonb, change_source varchar(50), change_type varchar(50) not null check (change_type in ('MANUAL','BULK_UPDATE','RULE_APPLIED','IMPORT','SYNC','ROLLBACK')), changed_at timestamp(6) with time zone not null, changed_by varchar(36), changed_by_name varchar(255), currency_code varchar(3) not null, new_amount numeric(19,4) not null, new_compare_at numeric(19,4), previous_amount numeric(19,4), previous_compare_at numeric(19,4), product_id varchar(36) not null, product_title varchar(255), rule_id varchar(36), rule_name varchar(255), sku varchar(255), variant_id varchar(36) not null, variant_title varchar(255), primary key (id));
CREATE TABLE IF NOT EXISTS price_set (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, type varchar(255) not null, primary key (id));
CREATE TABLE IF NOT EXISTS pricing_rule (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, config jsonb not null, description TEXT, end_at timestamp(6) with time zone, name varchar(255) not null, priority integer not null, start_at timestamp(6) with time zone, status varchar(20) not null check (status in ('ACTIVE','INACTIVE','SCHEDULED')), target_type varchar(50) check (target_type in ('ALL','PRODUCTS','CATEGORIES','COLLECTIONS','BRANDS')), type varchar(50) not null check (type in ('PERCENTAGE_DISCOUNT','FIXED_DISCOUNT','MARKUP','TIME_BASED','QUANTITY_BASED','TIERED')), primary key (id));
CREATE TABLE IF NOT EXISTS pricing_rule_targets (rule_id VARCHAR(36) not null, target_id varchar(255));
CREATE TABLE IF NOT EXISTS product (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, canonical_url varchar(255), description TEXT, discountable boolean not null, external_id varchar(255), external_key varchar(255), extracted_size varchar(255), handle varchar(255) not null unique, height varchar(255), hs_code varchar(255), is_giftcard boolean not null, length varchar(255), material varchar(255), mid_code varchar(255), origin_country varchar(255), shipping_profile_id varchar(255), size_type varchar(255), source varchar(255) not null check (source in ('OWNED')), status varchar(255) not null check (status in ('DRAFT','PROPOSED','PUBLISHED','REJECTED')), subtitle varchar(255), thumbnail varchar(255), title varchar(255) not null, weight varchar(255), width varchar(255), brand_id VARCHAR(36), canonical_category_id VARCHAR(36), collection_id VARCHAR(255), type_id VARCHAR(36), primary key (id));
CREATE TABLE IF NOT EXISTS product_category (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, description TEXT, external_id varchar(255) unique, handle varchar(255) not null unique, image varchar(255), is_active boolean not null, is_internal boolean not null, name varchar(255) not null, position integer not null, source varchar(255), parent_category_id VARCHAR(36), primary key (id));
...
CREATE TABLE IF NOT EXISTS product_collection (id VARCHAR(255) not null, created_at timestamp(6) with time zone not null, deleted_at timestamp(6) with time zone, description TEXT, handle varchar(255) not null unique, image_url TEXT, metadata jsonb, published boolean not null, title varchar(255) not null unique, updated_at timestamp(6) with time zone not null, primary key (id));
CREATE TABLE IF NOT EXISTS product_image (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, alt_text varchar(255), height integer, mime_type varchar(255), position integer not null, size bigint, url varchar(255) not null, width integer, product_id VARCHAR(36) not null, primary key (id));
CREATE TABLE IF NOT EXISTS product_option (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, position integer not null, title varchar(255) not null, product_id VARCHAR(36) not null, primary key (id));
...
CREATE TABLE IF NOT EXISTS product_tag (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, description TEXT, value varchar(255) not null unique, primary key (id));
...
CREATE TABLE IF NOT EXISTS product_type (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, description TEXT, value varchar(255) not null unique, primary key (id));
CREATE TABLE IF NOT EXISTS product_variant (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, allow_backorder boolean not null, barcode varchar(255), ean varchar(255), height varchar(255), hs_code varchar(255), length varchar(255), manage_inventory boolean not null, material varchar(255), mid_code varchar(255), origin_country varchar(255), sku varchar(255) unique, title varchar(255) not null, upc varchar(255), weight varchar(255), width varchar(255), product_id VARCHAR(36) not null, primary key (id));
CREATE TABLE IF NOT EXISTS product_variant_inventory_item (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, inventory_item_id varchar(255) not null, required_quantity integer not null, variant_id VARCHAR(36) not null, primary key (id), constraint uk_variant_inventory_item unique (variant_id, inventory_item_id));
CREATE TABLE IF NOT EXISTS product_variant_option (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, value varchar(255) not null, option_id VARCHAR(36) not null, variant_id VARCHAR(36) not null, primary key (id), constraint uk_variant_option unique (variant_id, option_id));
CREATE TABLE IF NOT EXISTS product_variant_price (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, amount numeric(19,4) not null, compare_at_price numeric(19,4), currency_code varchar(3) not null, max_quantity integer, min_quantity integer, region_id varchar(255), variant_id VARCHAR(36) not null, primary key (id));
CREATE TABLE IF NOT EXISTS promotion (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, buy_quantity integer, code varchar(255) not null unique, customer_usage_limit integer, description TEXT, ends_at timestamp(6) with time zone, get_discount_value float(53), get_quantity integer, is_active boolean not null, is_disabled boolean not null, is_stackable boolean not null, maximum_discount numeric(38,2), minimum_amount numeric(38,2), name varchar(255), priority integer not null, regions TEXT, starts_at timestamp(6) with time zone, type varchar(255) not null check (type in ('PERCENTAGE','FIXED','FREE_SHIPPING','BUY_X_GET_Y')), usage_count integer not null, usage_limit integer, value float(53) not null, primary key (id));
CREATE TABLE IF NOT EXISTS promotion_rule (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, attribute varchar(255), description TEXT, operator varchar(255), type varchar(255) not null check (type in ('MIN_SUBTOTAL','MIN_QUANTITY','PRODUCT_IDS','PRODUCT_COLLECTIONS','PRODUCT_TYPES','PRODUCT_TAGS','CUSTOMER_GROUPS')), value varchar(255), promotion_id VARCHAR(36) not null, primary key (id));
CREATE TABLE IF NOT EXISTS refund (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, amount numeric(19,4) not null, currency_code varchar(3) not null, data jsonb, note TEXT, order_id varchar(255), reason varchar(255) not null check (reason in ('DISCOUNT','RETURN','SWAP','CLAIM','CANCEL','OTHER')), status varchar(255) not null check (status in ('PENDING','SUCCEEDED','FAILED','CANCELED')), payment_id VARCHAR(36) not null, primary key (id));
CREATE TABLE IF NOT EXISTS region (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, automatic_taxes boolean not null, currency_code varchar(255) not null, gift_cards_taxable boolean not null, name varchar(255) not null, tax_code varchar(255), tax_inclusive boolean not null, tax_rate numeric(10,4), primary key (id), constraint idx_region_name unique (name));
...
CREATE TABLE IF NOT EXISTS return_item (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, description varchar(255), order_line_item_id varchar(255) not null, quantity integer not null, thumbnail varchar(255), title varchar(255) not null, total numeric(19,4) not null, unit_price numeric(19,4) not null, variant_id varchar(255), return_id VARCHAR(36) not null, primary key (id));
CREATE TABLE IF NOT EXISTS return_request (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, approved_at timestamp(6) with time zone, currency_code varchar(3) not null, customer_email varchar(255), customer_id varchar(255), order_display_id integer, order_id varchar(255) not null, reason varchar(30) not null check (reason in ('SIZE_TOO_SMALL','SIZE_TOO_LARGE','NOT_AS_DESCRIBED','QUALITY_ISSUE','CHANGED_MIND','WRONG_ITEM','DAMAGED','OTHER')), reason_note TEXT, received_at timestamp(6) with time zone, refund_amount numeric(19,4) not null, refund_id varchar(255), refunded_at timestamp(6) with time zone, rejected_at timestamp(6) with time zone, rejection_reason TEXT, requested_at timestamp(6) with time zone not null, return_deadline timestamp(6) with time zone not null, status varchar(20) not null check (status in ('REQUESTED','APPROVED','RECEIVED','REFUNDED','REJECTED','CANCELED')), primary key (id));
CREATE TABLE IF NOT EXISTS role (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, description varchar(255), name varchar(255) not null unique, primary key (id));
...
CREATE TABLE IF NOT EXISTS sales_channel (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, description TEXT, is_active boolean not null, is_disabled boolean not null, name varchar(255) not null, store_id VARCHAR(36) not null, primary key (id));
CREATE TABLE IF NOT EXISTS shipping_option (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, amount numeric(19,4) not null, data jsonb, is_active boolean not null, is_return boolean not null, name varchar(255) not null, price_type varchar(255) not null check (price_type in ('FLAT_RATE','CALCULATED')), region_id varchar(255) not null, requirements jsonb, profile_id VARCHAR(36) not null, provider_id VARCHAR(36), primary key (id));
CREATE TABLE IF NOT EXISTS shipping_profile (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, name varchar(255) not null, product_ids TEXT[], type varchar(255) not null check (type in ('DEFAULT','GIFT_CARD','CUSTOM')), primary key (id));
CREATE TABLE IF NOT EXISTS stock_location (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, address TEXT, address_1 varchar(255), address_2 varchar(255), city varchar(255), country_code varchar(2), fulfillment_enabled boolean not null, name varchar(255) not null, phone varchar(255), postal_code varchar(255), priority integer not null, province varchar(255), primary key (id));
CREATE TABLE IF NOT EXISTS store (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, default_currency_code varchar(3) not null, default_location_id varchar(255), default_region_id varchar(255), default_sales_channel_id varchar(255), invite_link_template varchar(255), name varchar(255) not null, payment_link_template varchar(255), swap_link_template varchar(255), primary key (id));
CREATE TABLE IF NOT EXISTS store_currency (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, currency_code varchar(3) not null, is_default boolean not null, store_id VARCHAR(36) not null, primary key (id));
CREATE TABLE IF NOT EXISTS store_settings (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, checkout_settings jsonb, contact_email varchar(255), contact_phone varchar(50), currency_display_format varchar(20) not null check (currency_display_format in ('SYMBOL_BEFORE','SYMBOL_AFTER','CODE_BEFORE','CODE_AFTER')), customer_tiers_enabled boolean not null, date_format varchar(20) not null check (date_format in ('DD_MM_YYYY','MM_DD_YYYY','YYYY_MM_DD','DD_MON_YYYY')), default_locale varchar(10) not null, description varchar(500), favicon_url varchar(2048), gift_cards_enabled boolean not null, guest_checkout_enabled boolean not null, legal_business_name varchar(255), logo_url varchar(2048), newsletter_enabled boolean not null, policies jsonb, product_comparison_enabled boolean not null, reviews_enabled boolean not null, seo_settings jsonb, shipping_settings jsonb, social_links jsonb, tax_id varchar(100), theme_settings jsonb, timezone varchar(50) not null, wishlist_enabled boolean not null, store_id VARCHAR(36) not null unique, primary key (id));
CREATE TABLE IF NOT EXISTS tax_rate (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, code varchar(255), name varchar(255) not null, product_categories TEXT, product_types TEXT, rate float(53) not null, shipping_option_id varchar(255), region_id VARCHAR(36) not null, primary key (id));
...
CREATE TABLE IF NOT EXISTS user_brand_follow (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, brand_id VARCHAR(36) not null, user_id VARCHAR(36) not null, primary key (id), constraint uk_user_brand_follow_user_brand unique (user_id, brand_id));
...
CREATE TABLE IF NOT EXISTS user_favorite (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, alert_enabled boolean not null, price_threshold numeric(38,2), product_id VARCHAR(36) not null, user_id VARCHAR(36) not null, primary key (id), constraint uk_user_favorite_user_product unique (user_id, product_id));
CREATE TABLE IF NOT EXISTS user_role (user_id VARCHAR(36) not null, role_id VARCHAR(36) not null, primary key (user_id, role_id));
CREATE TABLE IF NOT EXISTS user_size_preference (id VARCHAR(36) not null, created_at timestamp(6) with time zone not null, created_by varchar(255), deleted_at timestamp(6) with time zone, deleted_by varchar(255), metadata jsonb, updated_at timestamp(6) with time zone not null, updated_by varchar(255), version bigint not null, size varchar(255) not null, user_id VARCHAR(36) not null, primary key (id), constraint uk_user_size_preference_user_size unique (user_id, size));
...
CREATE INDEX IF NOT EXISTS idx_customer_total_spent on customer (total_spent);
...
CREATE INDEX IF NOT EXISTS idx_customer_activity_occurred on customer_activity_log (occurred_at);
...
CREATE INDEX IF NOT EXISTS idx_discount_activity_promotion on discount_activity (promotion_id);
CREATE INDEX IF NOT EXISTS idx_discount_activity_type on discount_activity (activity_type);
CREATE INDEX IF NOT EXISTS idx_discount_activity_created on discount_activity (created_at);
CREATE INDEX IF NOT EXISTS idx_discount_redemption_promotion on discount_redemption (promotion_id);
CREATE INDEX IF NOT EXISTS idx_discount_redemption_customer on discount_redemption (customer_id);
CREATE INDEX IF NOT EXISTS idx_discount_redemption_order on discount_redemption (order_id);
CREATE INDEX IF NOT EXISTS idx_discount_redemption_date on discount_redemption (redeemed_at);
...
CREATE INDEX IF NOT EXISTS idx_gift_card_issued_to on gift_card (issued_to_customer_id);
CREATE INDEX IF NOT EXISTS idx_gift_card_expires_at on gift_card (expires_at);
...
CREATE INDEX IF NOT EXISTS idx_inv_movement_inventory_item_id on inventory_movement (inventory_item_id);
CREATE INDEX IF NOT EXISTS idx_inv_movement_location_id on inventory_movement (location_id);
CREATE INDEX IF NOT EXISTS idx_inv_movement_inventory_level_id on inventory_movement (inventory_level_id);
CREATE INDEX IF NOT EXISTS idx_inv_movement_type on inventory_movement (movement_type);
CREATE INDEX IF NOT EXISTS idx_inv_movement_occurred_at on inventory_movement (occurred_at);
CREATE INDEX IF NOT EXISTS idx_inv_movement_reference_type on inventory_movement (reference_type);
CREATE INDEX IF NOT EXISTS idx_inv_movement_reference_id on inventory_movement (reference_id);
...
CREATE INDEX IF NOT EXISTS idx_order_event_order_id on order_event (order_id);
CREATE INDEX IF NOT EXISTS idx_order_event_type on order_event (event_type);
CREATE INDEX IF NOT EXISTS idx_order_event_created_at on order_event (created_at);
CREATE INDEX IF NOT EXISTS idx_order_event_deleted_at on order_event (deleted_at);
...
CREATE INDEX IF NOT EXISTS idx_price_change_log_variant on price_change_log (variant_id);
...
CREATE INDEX IF NOT EXISTS idx_price_change_log_change_type on price_change_log (change_type);
...
CREATE INDEX IF NOT EXISTS idx_pricing_rule_status on pricing_rule (status);
CREATE INDEX IF NOT EXISTS idx_pricing_rule_type on pricing_rule (type);
CREATE INDEX IF NOT EXISTS idx_pricing_rule_dates on pricing_rule (start_at, end_at);
CREATE INDEX IF NOT EXISTS idx_pricing_rule_deleted_at on pricing_rule (deleted_at);
...
CREATE INDEX IF NOT EXISTS idx_return_item_order_line_item_id on return_item (order_line_item_id);
CREATE INDEX IF NOT EXISTS idx_return_item_variant_id on return_item (variant_id);
CREATE INDEX IF NOT EXISTS idx_return_order_id on return_request (order_id);
CREATE INDEX IF NOT EXISTS idx_return_customer_id on return_request (customer_id);
CREATE INDEX IF NOT EXISTS idx_return_status on return_request (status);
CREATE INDEX IF NOT EXISTS idx_return_requested_at on return_request (requested_at);
CREATE INDEX IF NOT EXISTS idx_return_deleted_at on return_request (deleted_at);
...
CREATE INDEX IF NOT EXISTS idx_store_settings_deleted_at on store_settings (deleted_at);
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'FKhlweofrfmx0exq322pgu64egb'
    ) THEN
        alter table if exists discount_activity add constraint FKhlweofrfmx0exq322pgu64egb foreign key (promotion_id) references promotion;
    END IF;
END $$;
DO $$
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'FKt33hwe3c033fqdcb0r2o53a96'
    ) THEN
        alter table if exists discount_redemption add constraint FKt33hwe3c033fqdcb0r2o53a96 foreign key (promotion_id) references promotion;
    END IF;
END $$;
DO $$
BEGIN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'FKju1pjnhwmo68hsaiesh90nkk2'
    ) THEN
        alter table if exists pricing_rule_targets add constraint FKju1pjnhwmo68hsaiesh90nkk2 foreign key (rule_id) references pricing_rule;
    END IF;
END $$;
DO $$
BEGIN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'FKd7g2xwjwxq4ql2jq2e10lj7hl'
    ) THEN
        alter table if exists return_item add constraint FKd7g2xwjwxq4ql2jq2e10lj7hl foreign key (return_id) references return_request;
    END IF;
END $$;
DO $$
BEGIN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'FKausdwwmvr12bgl7h0vvvwgx1m'
    ) THEN
        alter table if exists store_settings add constraint FKausdwwmvr12bgl7h0vvvwgx1m foreign key (store_id) references store;
    END IF;
END $$;
DO $$
BEGIN
